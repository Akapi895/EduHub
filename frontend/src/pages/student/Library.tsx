...
export default function StudentLibrary() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-800">Thư viện tài liệu</h1>
        <p className="text-gray-500 mt-1">Tài liệu hệ thống và tài liệu từ các lớp bạn tham gia</p>
      </div>

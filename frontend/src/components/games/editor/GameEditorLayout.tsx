...
interface GameEditorLayoutProps {
  title: string;
  description: string;
  steps: GameEditorStepDefinition[];
  activeStep: GameEditorStepKey;
  onStepChange: (step: GameEditorStepKey) => void;
  actions?: ReactNode;
  children: ReactNode;
  stepMeta?: Partial<Record<GameEditorStepKey, StepMeta>>;
}

export default function GameEditorLayout({
  title,
  description,
  steps,
  activeStep,
